...
/**
 * DeviceLocation filter form base class.
 *
 * @package    mdm-server
 * @subpackage filter
 * @author     Dung Huynh
 ...
 */
abstract class BaseDeviceLocationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('device_location_filters[%s]');
