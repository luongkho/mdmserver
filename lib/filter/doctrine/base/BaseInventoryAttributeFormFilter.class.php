...
/**
 * InventoryAttribute filter form base class.
 *
 * @package    mdm-server
 * @subpackage filter
 * @author     Dung Huynh
 ...
 */
abstract class BaseInventoryAttributeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('inventory_attribute_filters[%s]');
